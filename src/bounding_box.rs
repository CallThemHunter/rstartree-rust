...
trait HasMargin<T, Other = Self> {
    fn margin(self) -> T;

    fn margin_diff(self, other: Other) -> T;
}

trait HasVolume<T, Other = Self> {
    fn volume(self) -> T;

    fn volume_diff(self, other: Other) -> T;
}

trait Overlap<T, Other = Self> {
    fn overlap(self, other: Other) -> Self;
}
